...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("MediZano - Microservicio de Catálogo y Medicamentos")
                        .version("1.0.0")
                        .description("Microservicio de Catálogo de Medicamentos, Productos Farmacéuticos y Búsqueda por Código de Barras"))
                .servers(List.of(
