...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("MediZano - Microservicio de Facturación y Reportes")
                        .version("1.0.0")
                        .description("Microservicio de Comprobantes de Venta (Boletas/Facturas), Devoluciones y Reportes Analíticos"))
                .servers(List.of(
